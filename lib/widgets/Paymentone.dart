...
class _PaymentoneState extends State<Paymentone> {
  ...
  Future<void> insertValueToFirestore()async{
    ...
    await firestore.collection('Payment').document().setData(map).then((value){
     MaterialPageRoute route = MarterialPageRoute(
      builder: (value) => MyService(),
     );
      Naviagator.of(context).pushAndRemoveUntil(route, (value)==>false);
...
//     shop.items.add(
//         Item(imageurl), user.uid); //  Item(itemname, price, description, originalPrice, imageurl), user.uid);
//   }
// }
